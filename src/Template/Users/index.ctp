            ...
            <?php foreach ($users as $user): ?>
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $user->id], ['confirm' => __('Are you sure you want to delete # {0}?', $user->id),'class'=>'x-btn x-btn-danger btn btn-danger btn-xs']) ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
