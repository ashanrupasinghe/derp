...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><?= __('Edit Delivery Staff: '.$delivery->id) ?> <small><?= __('edit delever ystaff') ?></small></h2>
                  ...
                  <div class="x_content">
			<?= $this->Form->create($delivery,['class'=>'form-horizontal form-label-left']) ?>
						...
						<div class="col-md-6 col-sm-6 col-xs-12">                          
                          <?php echo $this->Form->input('mobileNo',['label' => false,'class'=>'form-control col-md-7 col-xs-12']);?>                          
                                                         ...
                                                         <div class="form-group">
                                                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="vehicleNo">Vehicle No<span class="required">*</span></label>                        
						<div class="col-md-6 col-sm-6 col-xs-12">                          
                          <?php echo $this->Form->input('vehicleNo',['label' => false,'class'=>'form-control col-md-7 col-xs-12']);?>                          
                        </div>
                      </div> 
