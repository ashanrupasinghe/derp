...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><?= __('Edit Supplier') ?> <small><?= __('suplier ID: '.$supplier->id) ?></small></h2>
                  ...
                  <div class="x_content">
                    			  		    <?= $this->Form->create($supplier,['class'=>'form-horizontal form-label-left']) ?>
                    			  		    <div class="row">
  			  		<div class="col-md-6 col-sm-6 col-xs-12">
  			  		
  			  		                      <div class="form-group">
                        <label for="user_id" class="control-label col-md-3 col-sm-3 col-xs-12">User Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">                          
                          <?php echo $this->Form->input('longitude',['label' => false,'class'=>'form-control col-md-7 col-xs-12']);?>                          
                                                                              ...
                                                                              <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="contactNo">Contact No<span class="required">*</span></label>                        
						<div class="col-md-6 col-sm-6 col-xs-12">                          
                          <?php echo $this->Form->input('contactNo',['label' => false,'class'=>'form-control col-md-7 col-xs-12']);?>                          
                        </div>
                      </div> 
						...
						<div class="col-md-6 col-sm-6 col-xs-12">                          
                          <?php echo $this->Form->input('mobileNo',['label' => false,'class'=>'form-control col-md-7 col-xs-12']);?>                          
                                                                                        ...
                                                                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="faxNo">fax No<span class="required">*</span></label>                        
						<div class="col-md-6 col-sm-6 col-xs-12">                          
                          <?php echo $this->Form->input('faxNo',['label' => false,'class'=>'form-control col-md-7 col-xs-12']);?>                          
                        </div>
                      </div> 
                      
                                                                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="companyName">Company Name<span class="required">*</span></label>                        
						<div class="col-md-6 col-sm-6 col-xs-12">                          
                          <?php echo $this->Form->input('companyName',['label' => false,'class'=>'form-control col-md-7 col-xs-12']);?>                          
                        </div>
                      </div> 
                      <div class="form-group">
                                                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="regNo">Reg. No<span class="required">*</span></label>                        
						<div class="col-md-6 col-sm-6 col-xs-12">                          
                          <?php echo $this->Form->input('regNo',['label' => false,'class'=>'form-control col-md-7 col-xs-12']);?>                          
                        </div>
                      </div> 
