...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'availability' => ['type' => 'string', 'fixed' => true, 'length' => 1, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '1-available,2-not available', 'precision' => null],
        ...
        'status' => ['type' => 'string', 'fixed' => true, 'length' => 1, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '0-disabled,1-enabled', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'price' => 1,
            'availability' => 'Lorem ipsum dolor sit ame',
            'image' => 'Lorem ipsum dolor sit amet',
            'supplierId' => 1,
            'status' => 'Lorem ipsum dolor sit ame',
            'created' => '2016-08-20 10:01:47',
            'modified' => '2016-08-20 10:01:47'
        ],
    ];
}
